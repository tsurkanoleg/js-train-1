...
//(ділиться без остачі тільки на себе та на 1). Використовуйте цикл для 
//перевірки ділення числа на всі можливі дільники.
...
// Задача 9: Напишіть функцію getDayOfWeek, яка приймає номер дня тижня dayNumber (1-7) і 
//повертає рядок, що відповідає цьому дню тижня.
// Використовуйте конструкцію switch case для визначення дня тижня за його номером.

function getDayOfWeek(dayNumber) {

	switch (dayNumber) {
		case 1: dayNumber = "Понеділок"; break;
		case 2: dayNumber = "Вівторок"; break;
		case 3: dayNumber = "Середа"; break;
		case 4: dayNumber = "Четвер"; break;
		case 5: dayNumber = "П'ятниця"; break;
		case 6: dayNumber = "Субота"; break;
		case 7: dayNumber = "Неділя"; break;
		default: dayNumber = "Невірний номер дня";
	}
	return dayNumber
